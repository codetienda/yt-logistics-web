...
import ServicesCard from "./ServicesCard";
  ...
  const ServicesSection = () => {
    return (
      <section className="bg-white flex flex-col items-center text-gray-900 md:mt-10 p-6 py-8 md:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full my-6 md:max-w-6xl">
